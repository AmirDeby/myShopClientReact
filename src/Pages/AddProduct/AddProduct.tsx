...
class _AddProdcut extends React.Component<IAddProdcutProps, IAddProdcutState> {
                ...
                <div className='is-add-div'>
                    {isAdd
                        ...
                        <Alert className='alert' variant='secondary'>
                            <span style={{ color: this.generateColor(), fontSize: "30px" }}>Product has been added</span>
                        </Alert>
                        :
                        null}
                </div>
    ...
    generateColor = (): string => {
        const colors = ['indigo', 'teal', 'thistle', 'sienna', 'mediumspringgreen', 'lime', 'darkslategrey'];
